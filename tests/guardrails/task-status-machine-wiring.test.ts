 ...
 *
 * `declarationOf()` in `tests/helpers/source-blocks.ts` is the shared
 * bounder, but it only matches `const <name> = …;`. The same rule
 ...
 */
function functionBodyOf(src: string, name: string): string {
