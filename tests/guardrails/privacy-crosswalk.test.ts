...
describe('Privacy crosswalk — attribution', () => {
    ...
    it('docs/attributions.md records the MS project (MIT) source', () => {
        // Bound to the section that names the project — see `mdSection`. The
        // whole-document form let another attribution's MIT line stand in for
        // this one's.
        const doc = mdSection(
            readRaw('docs/attributions.md'),
