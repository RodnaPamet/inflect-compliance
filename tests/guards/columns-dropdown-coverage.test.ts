...
const EXEMPTIONS: Record<string, string> = {
    ...
    'admin/identity-joiner-passes/JoinerPassesClient.tsx':
        '(b) multi-table — a passes list plus the selected pass’s per-starter decisions, both with fixed derived columns. Hiding the intended address would hide the one field the seven-day observation window exists to show.',
