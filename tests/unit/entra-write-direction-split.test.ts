 ...
 * directly. When that verb lands, its own call site must pass `'joiner'` — a
 * default was deliberately NOT given, so forgetting the argument is a type
 * error rather than an inherited grant.
 *
