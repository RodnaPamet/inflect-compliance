 ...
 */
export function toolWasOffered(manifest: ToolManifest, name: string): boolean {
 ...
 */
export function toolIsLoadable(manifest: ToolManifest, name: string): boolean {
...
export function loadableTools(manifest: ToolManifest): string[] {
 ...
 */
export function toolManifestDigest(manifest: ToolManifest): string {
