...
// `controls.edit` matches the tier `bulkSetControlStatus` itself asserts. That alignment is
...
export const POST = withApiErrorHandling(
    requirePermission('controls.edit', async (req: NextRequest, _routeArgs, ctx) => {
        const body = await parseJsonBody(req, BulkControlStatusSchema);
